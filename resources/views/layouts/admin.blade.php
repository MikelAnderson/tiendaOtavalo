  ...
  <div class="row g-0">
    ...
    <div class="p-3 col fixed text-white bg-dark">
      ...
      <ul class="nav flex-column">
        ...
        <li><a href="{{ route('admin.categories.index') }}" class="nav-link text-white">- Admin - Categories</a></li>
        <li><a href="{{ route('admin.product.index') }}" class="nav-link text-white">- Admin - Products</a></li>
        <li><a href="{{ route('admin.comments.index') }}" class="nav-link text-white">- Admin - Comments</a></li>
        <li>
